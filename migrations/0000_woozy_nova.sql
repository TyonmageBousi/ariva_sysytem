...
ALTER TABLE "product_colors" ADD CONSTRAINT "product_colors_color_id_color_categories_id_fk" FOREIGN KEY ("color_id") REFERENCES "public"."color_categories"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
