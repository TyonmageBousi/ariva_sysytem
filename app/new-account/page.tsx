...
import NumberForm, { FieldNumberProps } from "@/app/components/form/NumberForm";
import DateForm, { FieldDateProps } from "@/app/components/form/DateForm";
import OptionsForm, { FiledOptionsProps, FiledOptions } from "@/app/components/form/OptionsForm";
...
export default function NewAccount() {
    ...
    const postalCodeProps: FieldNumberProps<NewAccountValues> = {
        label: "郵便番号",
        name: "postalCode",
        register,
        inputStyle: "mt-1 w-full rounded-xl border border-black/10 dark:border-white/15 bg-white dark:bg-neutral-900 px-3 py-2.5 text-[15px] outline-none focus:ring-4 ring-amber-500/20 focus:border-amber-500",
