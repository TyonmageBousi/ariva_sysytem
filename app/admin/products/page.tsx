    ...
    export default function Product() {
        ...
        return (
            <div className="max-w-6xl w-full mx-auto py-8 border">
                ...
                <div className='grid grid-cols-12 gap-6 w-full border'>
                    <div className="col-span-8 grid gap-6">
                        ...
                        <section className="rounded-2xl border border-black/10 bg-neutral-800 p-6">
                            <label htmlFor="images" className="flex flex-col items-center justify-center 
                    ...
                    focus-visible:ring-4 focus-visible:ring-amber-500/20"
                            ...
                            <div className='grid grid-cols-3 mt-4 gap-3'>
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="relative aspect-square rounded-xl overflow-hidden ring-1 ring-black/10 bg-neutral-100">
                                        <div className="absolute inset-0 grid place-items-center text-xs text-neutral-500">プレビュー {i}</div>
                                        <button type="button" className="absolute right-1 top-1 inline-flex items-center rounded-md bg-white/90 
