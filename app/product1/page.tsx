...
import ProductDetail, { ProductDetailData } from '@/app/components/user/ProductDetail'
import ProductDetails, { ProductDetailsData } from '@/app/components/user/ProductDetails'
