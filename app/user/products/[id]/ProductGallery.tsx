...
export default function ProductDetails({ productDetailsData }: Props) {
    ...
    return (
        <section
            ...
            style={{
                background:
                    'radial-gradient(1200px circle at 50% 18%, rgba(255,220,170,0.10), rgba(0,0,0,0.0) 45%), radial-gradient(circle at 50% 60%, rgba(255,255,255,0.04) 0%, rgba(0,0,0,0.92) 58%, rgba(0,0,0,1) 100%), #000000'
            }}
        >
